        ...
        _getSortFunction(e) {
            ...
            if (d) {
                ...
                return function (e, t) {
                    ...
                    for (i = 0; i < d; i++)
                        if (
                            ((n = l[i].field), (s = a[i] * O(c(n, e), c(n, t))))
                        )
                            return s;
                    return 0;
                };
    ...
    class J extends (function (e) {
        ...
        setup() {
            ...
            (null === t.maxItems || t.maxItems > 1) &&
                ...
                t.load &&
                    t.loadThrottle &&
                    (t.load = z(t.load, t.loadThrottle)),
        ...
        setTextboxValue(e = "") {
            ...
            t.value !== e &&
                ((t.value = e), _(t, "update"), (this.lastValue = e));
        }
        getValue() {
        ...
        refreshValidityState() {
            ...
            e.input.checkValidity &&
                ((e.isValid = e.input.checkValidity()),
